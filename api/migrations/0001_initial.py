# Generated by Django 4.1.7 on 2023-02-24 23:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.account')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='The permissions this user has', related_name='customuser_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            model_name='account',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.customuser'),
        ),
    ]
